# html/cross-origin-opener-policy/coop-coep-sandbox.https.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/coop-coep-sandbox.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/coop-coep-sandbox.https.html"
}
```
