# html/cross-origin-opener-policy/reporting/document-reporting/report-only-four-reports.https.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/reporting/document-reporting/report-only-four-reports.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/reporting/document-reporting/report-only-four-reports.https.html"
}
```
