...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/iframe-popup-unsafe-none-to-same-origin.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/iframe-popup-unsafe-none-to-same-origin.https.html"
}
```
