# html/cross-origin-opener-policy/javascript-url.https.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/javascript-url.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/javascript-url.https.html"
}
```
