...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/popup-unsafe-none-with-cross-origin.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/popup-unsafe-none-with-cross-origin.https.html"
}
```
