...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/historical/popup-same-site-with-same-site.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/historical/popup-same-site-with-same-site.https.html"
}
```
