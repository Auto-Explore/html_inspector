...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/historical/coep-navigate-popup-unsafe-inherit.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/historical/coep-navigate-popup-unsafe-inherit.https.html"
}
```
