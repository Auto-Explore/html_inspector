...
{
  "format_version": 1,
  "file": "html/cross-origin-opener-policy/popup-unspecified-with-same-origin.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-opener-policy/popup-unspecified-with-same-origin.https.html"
}
```
