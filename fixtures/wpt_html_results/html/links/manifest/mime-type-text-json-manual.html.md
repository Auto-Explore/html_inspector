# html/links/manifest/mime-type-text-json-manual.html
...
{
  "format_version": 1,
  "file": "html/links/manifest/mime-type-text-json-manual.html",
...
```json
{
  ...
  "source_name": "html/links/manifest/mime-type-text-json-manual.html"
}
```
