...
{
  "format_version": 1,
  "file": "html/interaction/focus/document-level-focus-apis/document-level-apis.html",
...
```json
{
  ...
  "source_name": "html/interaction/focus/document-level-focus-apis/document-level-apis.html"
}
```
