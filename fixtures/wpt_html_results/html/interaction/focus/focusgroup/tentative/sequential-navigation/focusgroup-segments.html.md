# html/interaction/focus/focusgroup/tentative/sequential-navigation/focusgroup-segments.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/sequential-navigation/focusgroup-segments.html",
...
<div id=toolbar focusgroup="toolbar wrap" aria-label="Text formatting">
  <button id=bold type="button" focusgroupstart>Bold (priority)</button>
  ...
  <button id=underline type="button" focusgroupstart>Underline (priority)</button>
</div>
...
<div id=complex-focusgroup focusgroup="toolbar no-memory">
  ...
  <button id=item2 focusgroupstart>Item 2 (priority)</button>
...
```json
{
  "messages": [
    ...
    },
    {
      "category": "Aria",
      "code": "aria.aria_label.prohibited_on_role.generic",
      "message": "The “aria-label” attribute must not be specified on any “span” element unless the element has a “role” value other than “caption”, “code”, “deletion”, “emphasis”, “generic”, “insertion”, “paragraph”, “presentation”, “strong”, “subscript”, or “superscript”.",
      "severity": "Error",
      "span": {
        "byte_end": 1060,
        "byte_start": 998,
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/sequential-navigation/focusgroup-segments.html"
}
```
