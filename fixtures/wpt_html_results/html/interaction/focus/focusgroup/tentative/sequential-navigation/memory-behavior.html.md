# html/interaction/focus/focusgroup/tentative/sequential-navigation/memory-behavior.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/sequential-navigation/memory-behavior.html",
...
<div id=memory-focusgroup focusgroup="toolbar">
  ...
  <button id=memory-item2 focusgroupstart>Item 2 (priority)</button>
...
<div id=segments-focusgroup focusgroup="toolbar">
  ...
  <button id=seg-item2 focusgroupstart>Segment Item 2 (priority)</button>
  <div focusgroup="none">
...
<script>
  promise_test(async t => {
    ...
    assert_equals(document.activeElement, memoryItem2, "First tab entry should use focusgroupstart element");
  ...
  promise_test(async t => {
    ...
    between.focus();
    await navigateFocusForward();
    assert_equals(document.activeElement, noMemoryItem2, "Entry should use focusgroupstart element");
    ...
    await sendTabBackward();
    assert_equals(document.activeElement, noMemoryItem2, "Re-entering should use focusgroupstart, not remember last focus");
  ...
  promise_test(async t => {
    ...
    await navigateFocusForward();
    assert_equals(document.activeElement, segItem2, "Should enter at focusgroupstart element");
  ...
  promise_test(async t => {
    ...
    await sendTabBackward();
    assert_equals(document.activeElement, segItem2, "Shift+Tab from opted-out should enter first segment at focusgroupstart element");
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/sequential-navigation/memory-behavior.html"
}
```
