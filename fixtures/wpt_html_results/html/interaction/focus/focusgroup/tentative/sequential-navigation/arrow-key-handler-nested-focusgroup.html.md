# html/interaction/focus/focusgroup/tentative/sequential-navigation/arrow-key-handler-nested-focusgroup.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/sequential-navigation/arrow-key-handler-nested-focusgroup.html",
...
<script>
  ...
  promise_test(async t => {
    ...
    await focusAndKeyPress(btn2, kArrowRight);
    assert_equals(document.activeElement, search);
  }, "Arrow navigation works in both outer and inner nested focusgroups");
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/sequential-navigation/arrow-key-handler-nested-focusgroup.html"
}
```
