# html/interaction/focus/focusgroup/tentative/opt-out-barriers/none-creates-barriers.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/opt-out-barriers/none-creates-barriers.html",
...
<div id=root focusgroup="toolbar">
  ...
  <div id=optout focusgroup="none">
    <button id=optout_item1 tabindex=0>Opted out item 1</button>
    <div>
      <button id=optout_item2 tabindex=0>Opted out item 2</button>
    </div>
  </div>

  <button id=item3 tabindex=0>Item 3</button>
  <button id=item4 tabindex=0>Item 4</button>
</div>
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/opt-out-barriers/none-creates-barriers.html"
}
```
