# html/interaction/focus/focusgroup/tentative/reading-flow-navigation/partial-reordering.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/reading-flow-navigation/partial-reordering.html",
...
<script>
  ...
  promise_test(async t => {
    ...
    await assert_arrow_navigation_bidirectional(buttonsInVisualOrder, true);
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/reading-flow-navigation/partial-reordering.html"
}
```
