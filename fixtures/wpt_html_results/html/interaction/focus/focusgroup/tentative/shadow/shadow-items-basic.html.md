...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/shadow/shadow-items-basic.html",
...
<script>
  ...
  promise_test(async t => {
    ...
    sr.innerHTML = `
      ...
      <button id=item2 tabindex=0>Two</button>
      <button id=item3 tabindex=0>Three</button>`;
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/shadow/shadow-items-basic.html"
}
```
