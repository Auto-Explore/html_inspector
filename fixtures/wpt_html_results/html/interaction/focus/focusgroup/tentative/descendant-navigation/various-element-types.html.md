# html/interaction/focus/focusgroup/tentative/descendant-navigation/various-element-types.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/descendant-navigation/various-element-types.html",
...
<div id=root focusgroup="toolbar">
  ...
  <section>
    <div>
      <span id=item3 tabindex=0>Item 3 (in section)</span>
    </div>
  </section>
  <article>
    <span id=item4 tabindex=0>Item 4 (in article)</span>
  </article>
  <div>
    <span id=item5 tabindex=0>Item 5 (deeply nested)</span>
  </div>
  <nav>
    <div>
      <span id=item6 tabindex=0>Item 6 (in nav)</span>
    </div>
  </nav>
  <div>
    <div tabindex=0 id=item7>Item 7 (focusable div)</div>
  </div>
  <details>
    <summary id=item8 tabindex=0>Item 8 (summary)</summary>
    <p>Details content</p>
  </details>
  <div>
    <span id=item9 tabindex=0>Item 9 (final)</span>
  </div>
</div>
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/descendant-navigation/various-element-types.html"
}
```
