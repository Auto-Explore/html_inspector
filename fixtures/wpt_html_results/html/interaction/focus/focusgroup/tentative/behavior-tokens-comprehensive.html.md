# html/interaction/focus/focusgroup/tentative/behavior-tokens-comprehensive.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/behavior-tokens-comprehensive.html",
...
<script>
  ...
  promise_test(async t => {
    ...
    testDiv.innerHTML = '<span id=combo1 tabindex=0>combo1</span><span id=combo2 tabindex=0>combo2</span>';
  ...
  promise_test(async t => {
    ...
    testTable.innerHTML = '<tr><td id=gridcombo1 tabindex=0>gridcombo1</td><td id=gridcombo2 tabindex=0>gridcombo2</td></tr>';
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/behavior-tokens-comprehensive.html"
}
```
