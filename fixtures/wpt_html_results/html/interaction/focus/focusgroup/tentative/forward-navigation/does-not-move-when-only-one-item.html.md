# html/interaction/focus/focusgroup/tentative/forward-navigation/does-not-move-when-only-one-item.html
...
{
  "format_version": 1,
  "file": "html/interaction/focus/focusgroup/tentative/forward-navigation/does-not-move-when-only-one-item.html",
...
```json
{
  ...
  "source_name": "html/interaction/focus/focusgroup/tentative/forward-navigation/does-not-move-when-only-one-item.html"
}
```
