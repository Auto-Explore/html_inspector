...
{
  "format_version": 1,
  "file": "html/interaction/focus/the-autofocus-attribute/autofocus-in-not-fully-active-document.html",
...
```json
{
  ...
  "source_name": "html/interaction/focus/the-autofocus-attribute/autofocus-in-not-fully-active-document.html"
}
```
