...
{
  "format_version": 1,
  "file": "html/interaction/focus/the-autofocus-attribute/first-when-later-but-before.html",
...
```json
{
  ...
  "source_name": "html/interaction/focus/the-autofocus-attribute/first-when-later-but-before.html"
}
```
