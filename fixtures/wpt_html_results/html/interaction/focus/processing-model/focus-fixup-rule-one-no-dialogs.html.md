...
{
  "format_version": 1,
  "file": "html/interaction/focus/processing-model/focus-fixup-rule-one-no-dialogs.html",
...
```json
{
  ...
  "source_name": "html/interaction/focus/processing-model/focus-fixup-rule-one-no-dialogs.html"
}
```
