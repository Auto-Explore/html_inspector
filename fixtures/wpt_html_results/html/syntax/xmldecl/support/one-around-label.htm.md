# html/syntax/xmldecl/support/one-around-label.htm
...
{
  "format_version": 1,
  "file": "html/syntax/xmldecl/support/one-around-label.htm",
...
```json
{
  ...
  "source_name": "html/syntax/xmldecl/support/one-around-label.htm"
}
```
