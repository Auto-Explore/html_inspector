# html/syntax/xmldecl/support/no-quotes-space.htm
...
{
  "format_version": 1,
  "file": "html/syntax/xmldecl/support/no-quotes-space.htm",
...
```json
{
  ...
  "source_name": "html/syntax/xmldecl/support/no-quotes-space.htm"
}
```
