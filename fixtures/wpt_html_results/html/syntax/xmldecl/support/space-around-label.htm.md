# html/syntax/xmldecl/support/space-around-label.htm
...
{
  "format_version": 1,
  "file": "html/syntax/xmldecl/support/space-around-label.htm",
...
```json
{
  ...
  "source_name": "html/syntax/xmldecl/support/space-around-label.htm"
}
```
