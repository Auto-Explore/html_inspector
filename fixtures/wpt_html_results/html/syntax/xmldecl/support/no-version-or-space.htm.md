# html/syntax/xmldecl/support/no-version-or-space.htm
...
{
  "format_version": 1,
  "file": "html/syntax/xmldecl/support/no-version-or-space.htm",
...
```json
{
  ...
  "source_name": "html/syntax/xmldecl/support/no-version-or-space.htm"
}
```
