# html/syntax/xmldecl/support/kilobyte-plus-one-before.htm
...
{
  "format_version": 1,
  "file": "html/syntax/xmldecl/support/kilobyte-plus-one-before.htm",
...
```json
{
  ...
  "source_name": "html/syntax/xmldecl/support/kilobyte-plus-one-before.htm"
}
```
