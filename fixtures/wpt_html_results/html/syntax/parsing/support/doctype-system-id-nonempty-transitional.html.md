...
{
  "format_version": 1,
  "file": "html/syntax/parsing/support/doctype-system-id-nonempty-transitional.html",
...
```json
{
  ...
  "source_name": "html/syntax/parsing/support/doctype-system-id-nonempty-transitional.html"
}
```
