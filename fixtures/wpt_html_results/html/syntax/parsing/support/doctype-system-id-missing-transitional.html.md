...
{
  "format_version": 1,
  "file": "html/syntax/parsing/support/doctype-system-id-missing-transitional.html",
...
```json
{
  ...
  "source_name": "html/syntax/parsing/support/doctype-system-id-missing-transitional.html"
}
```
