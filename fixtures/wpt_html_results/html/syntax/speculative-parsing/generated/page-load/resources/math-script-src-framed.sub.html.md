# html/syntax/speculative-parsing/generated/page-load/resources/math-script-src-framed.sub.html
...
{
  "format_version": 1,
  "file": "html/syntax/speculative-parsing/generated/page-load/resources/math-script-src-framed.sub.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Element “script” not allowed as child of “math” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 492,
        "byte_start": 365,
  ...
  "source_name": "html/syntax/speculative-parsing/generated/page-load/resources/math-script-src-framed.sub.html"
}
```
