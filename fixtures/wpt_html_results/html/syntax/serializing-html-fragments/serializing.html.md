...
{
  "format_version": 1,
  "file": "html/syntax/serializing-html-fragments/serializing.html",
...
```json
{
  "messages": [
    {
      "category": "Html",
      "code": "html.svg.xmlns.prefix.disallowed",
      "message": "Attribute “xmlns:svg” not allowed here.",
      "severity": "Warning",
      "span": {
        "byte_end": 661,
        "byte_start": 639,
    ...
    },
    {
      ...
      "message": "Element “style” not allowed as child of “span” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 798,
        "byte_start": 791,
    ...
    },
    {
      ...
      "message": "Element “c” not allowed as child of “b” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 1110,
        "byte_start": 1107,
    ...
    {
      "category": "Html",
      "code": "html.a.transparent.disallowed_child_in_phrasing",
      "message": "Element “c” not allowed as child of “a” in this context. Note: The “a” element has a transparent content model; its allowed content is inherited from its parent element.",
      "severity": "Warning",
      "span": {
        "byte_end": 1110,
        "byte_start": 1107,
    ...
    },
    {
      "category": "Html",
      "code": "html.unknown_element.not_allowed",
      "message": "Element “d” not allowed as child of “a” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 1121,
        "byte_start": 1118,
    ...
    },
    {
      "category": "Html",
      "code": "html.unknown_element.completely_unknown",
      "message": "The “d” element is a completely-unknown element that is not allowed anywhere in any HTML content.",
      "severity": "Warning",
      "span": {
        "byte_end": 1121,
        "byte_start": 1118,
    ...
    },
    {
      "category": "Html",
      "code": "html.a.transparent.disallowed_child_in_phrasing",
      "message": "Element “d” not allowed as child of “a” in this context. Note: The “a” element has a transparent content model; its allowed content is inherited from its parent element.",
      "severity": "Warning",
      "span": {
        "byte_end": 1121,
        "byte_start": 1118,
    ...
    },
    {
      "category": "Html",
      "code": "html.unknown_element.not_allowed",
      "message": "Element “f” not allowed as child of “a” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 1129,
        "byte_start": 1126,
    ...
    },
    {
      "category": "Html",
      "code": "html.a.transparent.disallowed_child_in_phrasing",
      "message": "Element “f” not allowed as child of “a” in this context. Note: The “a” element has a transparent content model; its allowed content is inherited from its parent element.",
      "severity": "Warning",
      "span": {
        "byte_end": 1129,
        "byte_start": 1126,
    ...
    },
    {
      "category": "Html",
      "code": "html.unknown_element.not_allowed",
      "message": "Element “g” not allowed as child of “f” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 1132,
        "byte_start": 1129,
    ...
    },
    {
      "category": "Html",
      "code": "html.unknown_element.completely_unknown",
      "message": "The “g” element is a completely-unknown element that is not allowed anywhere in any HTML content.",
      "severity": "Warning",
      "span": {
        "byte_end": 1132,
        "byte_start": 1129,
    ...
    },
    {
      "category": "Html",
      "code": "html.a.transparent.disallowed_child_in_phrasing",
      "message": "Element “g” not allowed as child of “a” in this context. Note: The “a” element has a transparent content model; its allowed content is inherited from its parent element.",
      "severity": "Warning",
      "span": {
        "byte_end": 1132,
        "byte_start": 1129,
  ...
  "source_name": "html/syntax/serializing-html-fragments/serializing.html"
}
```
