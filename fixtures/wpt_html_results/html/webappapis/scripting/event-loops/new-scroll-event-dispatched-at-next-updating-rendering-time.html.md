...
{
  "format_version": 1,
  "file": "html/webappapis/scripting/event-loops/new-scroll-event-dispatched-at-next-updating-rendering-time.html",
...
```json
{
  ...
  "source_name": "html/webappapis/scripting/event-loops/new-scroll-event-dispatched-at-next-updating-rendering-time.html"
}
```
