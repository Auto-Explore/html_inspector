...
{
  "format_version": 1,
  "file": "html/webappapis/scripting/processing-model-2/body-onerror-compile-error.html",
...
```json
{
  ...
  "source_name": "html/webappapis/scripting/processing-model-2/body-onerror-compile-error.html"
}
```
