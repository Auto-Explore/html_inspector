...
{
  "format_version": 1,
  "file": "html/webappapis/scripting/processing-model-2/runtime-error-in-body-onerror.html",
...
```json
{
  ...
  "source_name": "html/webappapis/scripting/processing-model-2/runtime-error-in-body-onerror.html"
}
```
