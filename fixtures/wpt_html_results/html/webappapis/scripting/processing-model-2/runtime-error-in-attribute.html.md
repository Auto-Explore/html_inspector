# html/webappapis/scripting/processing-model-2/runtime-error-in-attribute.html
...
{
  "format_version": 1,
  "file": "html/webappapis/scripting/processing-model-2/runtime-error-in-attribute.html",
...
```json
{
  ...
  "source_name": "html/webappapis/scripting/processing-model-2/runtime-error-in-attribute.html"
}
```
