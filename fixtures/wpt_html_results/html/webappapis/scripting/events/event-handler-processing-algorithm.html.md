...
{
  "format_version": 1,
  "file": "html/webappapis/scripting/events/event-handler-processing-algorithm.html",
...
```json
{
  ...
  "source_name": "html/webappapis/scripting/events/event-handler-processing-algorithm.html"
}
```
