# html/webappapis/user-prompts/print-during-beforeunload.html
...
{
  "format_version": 1,
  "file": "html/webappapis/user-prompts/print-during-beforeunload.html",
...
```json
{
  ...
  "source_name": "html/webappapis/user-prompts/print-during-beforeunload.html"
}
```
