...
{
  "format_version": 1,
  "file": "html/semantics/tabular-data/the-table-element/caption-methods.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Element “foo:caption” not allowed as child of “body” in this context.",
      "severity": "Warning",
      "span": {
        "byte_end": 874,
        "byte_start": 861,
    ...
    },
    {
      ...
      "message": "The “foo:caption” element is a completely-unknown element that is not allowed anywhere in any HTML content.",
      "severity": "Warning",
      "span": {
        "byte_end": 874,
        "byte_start": 861,
  ...
  "source_name": "html/semantics/tabular-data/the-table-element/caption-methods.html"
}
```
