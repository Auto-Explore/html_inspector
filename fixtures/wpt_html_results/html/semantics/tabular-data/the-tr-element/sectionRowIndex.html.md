...
{
  "format_version": 1,
  "file": "html/semantics/tabular-data/the-tr-element/sectionRowIndex.html",
...
```json
{
  "messages": [
    ...
    {
      "category": "Html",
      "code": "html.table.row.width.exceeds_first_row",
      "message": "A table row was 1 columns wide and exceeded the column count established by the first row (0).",
      "severity": "Warning",
      "span": {
        "byte_end": 667,
        "byte_start": 659,
  ...
  "source_name": "html/semantics/tabular-data/the-tr-element/sectionRowIndex.html"
}
```
