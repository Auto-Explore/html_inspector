...
{
  "format_version": 1,
  "file": "html/semantics/popovers/popover-attribute-basic.html",
...
```json
{
  "messages": [
    ...
    },
    {
      ...
      "message": "Bad value “true” for attribute “popover” on element “div”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1145,
        "byte_start": 1127,
    ...
    },
    {
      "category": "Html",
      "code": "html.popover.value.invalid",
      "message": "Bad value “popover” for attribute “popover” on element “div”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1225,
        "byte_start": 1204,
  ...
  "source_name": "html/semantics/popovers/popover-attribute-basic.html"
}
```
