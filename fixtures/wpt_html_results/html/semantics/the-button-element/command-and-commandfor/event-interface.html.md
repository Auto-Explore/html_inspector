# html/semantics/the-button-element/command-and-commandfor/event-interface.html
...
{
  "format_version": 1,
  "file": "html/semantics/the-button-element/command-and-commandfor/event-interface.html",
...
```json
{
  ...
  "source_name": "html/semantics/the-button-element/command-and-commandfor/event-interface.html"
}
```
