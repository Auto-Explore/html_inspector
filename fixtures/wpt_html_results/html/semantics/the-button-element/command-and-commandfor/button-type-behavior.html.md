# html/semantics/the-button-element/command-and-commandfor/button-type-behavior.html
...
{
  "format_version": 1,
  "file": "html/semantics/the-button-element/command-and-commandfor/button-type-behavior.html",
...
```json
{
  ...
  "source_name": "html/semantics/the-button-element/command-and-commandfor/button-type-behavior.html"
}
```
