# html/semantics/the-button-element/command-and-commandfor/toggleevent-source-attribute-retargeting.html
...
{
  "format_version": 1,
  "file": "html/semantics/the-button-element/command-and-commandfor/toggleevent-source-attribute-retargeting.html",
...
```json
{
  ...
  "source_name": "html/semantics/the-button-element/command-and-commandfor/toggleevent-source-attribute-retargeting.html"
}
```
