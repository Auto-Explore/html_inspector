# html/semantics/the-button-element/command-and-commandfor/command-reflection.html
...
{
  "format_version": 1,
  "file": "html/semantics/the-button-element/command-and-commandfor/command-reflection.html",
...
```json
{
  ...
  "source_name": "html/semantics/the-button-element/command-and-commandfor/command-reflection.html"
}
```
