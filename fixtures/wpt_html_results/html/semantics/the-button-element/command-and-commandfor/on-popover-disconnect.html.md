# html/semantics/the-button-element/command-and-commandfor/on-popover-disconnect.html
...
{
  "format_version": 1,
  "file": "html/semantics/the-button-element/command-and-commandfor/on-popover-disconnect.html",
...
```json
{
  ...
  "source_name": "html/semantics/the-button-element/command-and-commandfor/on-popover-disconnect.html"
}
```
