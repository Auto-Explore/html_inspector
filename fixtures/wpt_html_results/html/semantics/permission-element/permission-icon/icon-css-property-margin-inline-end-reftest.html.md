# html/semantics/permission-element/permission-icon/icon-css-property-margin-inline-end-reftest.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/permission-icon/icon-css-property-margin-inline-end-reftest.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/permission-icon/icon-css-property-margin-inline-end-reftest.html"
}
```
