# html/semantics/permission-element/permission-icon/icon-hidden-reftest.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/permission-icon/icon-hidden-reftest.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/permission-icon/icon-hidden-reftest.html"
}
```
