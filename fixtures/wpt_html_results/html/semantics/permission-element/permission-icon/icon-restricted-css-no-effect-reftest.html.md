# html/semantics/permission-element/permission-icon/icon-restricted-css-no-effect-reftest.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/permission-icon/icon-restricted-css-no-effect-reftest.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/permission-icon/icon-restricted-css-no-effect-reftest.html"
}
```
