# html/semantics/permission-element/permission-icon/icon-css-property-min-height-reftest-ref.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/permission-icon/icon-css-property-min-height-reftest-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/permission-icon/icon-css-property-min-height-reftest-ref.html"
}
```
