...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/permission-icon/icon-css-property-fill-reftest-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/permission-icon/icon-css-property-fill-reftest-ref.html"
}
```
