# html/semantics/permission-element/permission-element-with-comment-ref.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/permission-element-with-comment-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/permission-element-with-comment-ref.html"
}
```
