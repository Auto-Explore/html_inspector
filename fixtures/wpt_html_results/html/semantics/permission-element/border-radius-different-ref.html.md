# html/semantics/permission-element/border-radius-different-ref.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/border-radius-different-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/border-radius-different-ref.html"
}
```
