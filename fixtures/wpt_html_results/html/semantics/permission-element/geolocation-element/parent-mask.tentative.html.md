# html/semantics/permission-element/geolocation-element/parent-mask.tentative.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/geolocation-element/parent-mask.tentative.html",
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Geolocation Element: invalid if parent has mask</title>
    <link
      rel="help"
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/geolocation-element/parent-mask.tentative.html"
}
```
