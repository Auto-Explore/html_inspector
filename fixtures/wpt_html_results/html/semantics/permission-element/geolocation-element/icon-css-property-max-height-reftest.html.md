# html/semantics/permission-element/geolocation-element/icon-css-property-max-height-reftest.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/geolocation-element/icon-css-property-max-height-reftest.html",
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/geolocation-element/icon-css-property-max-height-reftest.html"
}
```
