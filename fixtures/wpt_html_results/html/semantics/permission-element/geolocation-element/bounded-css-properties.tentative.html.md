# html/semantics/permission-element/geolocation-element/bounded-css-properties.tentative.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/geolocation-element/bounded-css-properties.tentative.html",
...
<body>
<!--The geolocation element should have some limits for specific properties:
...
<geolocation id="id-over-bounds"></geolocation>
<geolocation id="id-under-bounds"></geolocation>
<geolocation id="id-within-bounds"></geolocation>
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/geolocation-element/bounded-css-properties.tentative.html"
}
```
