# html/semantics/permission-element/geolocation-element/icon-restricted-css-no-effect-reftest.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/geolocation-element/icon-restricted-css-no-effect-reftest.html",
...
<link rel="match" href="standard-location-element-ref.html">
<style>
  ::permission-icon {
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/geolocation-element/icon-restricted-css-no-effect-reftest.html"
}
```
