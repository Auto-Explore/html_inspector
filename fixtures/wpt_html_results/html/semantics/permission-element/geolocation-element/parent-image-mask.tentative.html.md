# html/semantics/permission-element/geolocation-element/parent-image-mask.tentative.html
...
{
  "format_version": 1,
  "file": "html/semantics/permission-element/geolocation-element/parent-image-mask.tentative.html",
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Geolocation Element: invalid if parent has mask-image</title>
    <link
      rel="help"
...
```json
{
  ...
  "source_name": "html/semantics/permission-element/geolocation-element/parent-image-mask.tentative.html"
}
```
