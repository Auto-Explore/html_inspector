...
{
  "format_version": 1,
  "file": "html/semantics/document-metadata/the-link-element/link-load-error-events.html",
...
```json
{
  ...
  "source_name": "html/semantics/document-metadata/the-link-element/link-load-error-events.html"
}
```
