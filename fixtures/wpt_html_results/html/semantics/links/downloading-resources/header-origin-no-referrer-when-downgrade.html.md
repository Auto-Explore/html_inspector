...
{
  "format_version": 1,
  "file": "html/semantics/links/downloading-resources/header-origin-no-referrer-when-downgrade.html",
...
```json
{
  ...
  "source_name": "html/semantics/links/downloading-resources/header-origin-no-referrer-when-downgrade.html"
}
```
