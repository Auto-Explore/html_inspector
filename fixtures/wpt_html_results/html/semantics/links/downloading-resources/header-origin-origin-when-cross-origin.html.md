...
{
  "format_version": 1,
  "file": "html/semantics/links/downloading-resources/header-origin-origin-when-cross-origin.html",
...
```json
{
  ...
  "source_name": "html/semantics/links/downloading-resources/header-origin-origin-when-cross-origin.html"
}
```
