...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/the-img-element/image-loading-lazy-use-list-of-available-images.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/the-img-element/image-loading-lazy-use-list-of-available-images.html"
}
```
