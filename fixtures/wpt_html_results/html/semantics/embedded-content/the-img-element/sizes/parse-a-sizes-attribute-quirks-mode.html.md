...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/the-img-element/sizes/parse-a-sizes-attribute-quirks-mode.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/the-img-element/sizes/parse-a-sizes-attribute-quirks-mode.html"
}
```
