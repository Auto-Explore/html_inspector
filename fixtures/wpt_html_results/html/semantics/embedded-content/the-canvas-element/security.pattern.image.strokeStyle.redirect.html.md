...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/the-canvas-element/security.pattern.image.strokeStyle.redirect.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/the-canvas-element/security.pattern.image.strokeStyle.redirect.html"
}
```
