...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/media-elements/user-interface/muted.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/media-elements/user-interface/muted.html"
}
```
