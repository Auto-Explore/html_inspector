...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/media-elements/loading-the-media-resource/load-removes-queued-error-event.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/media-elements/loading-the-media-resource/load-removes-queued-error-event.html"
}
```
