...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/media-elements/readyState_during_loadedmetadata.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/media-elements/readyState_during_loadedmetadata.html"
}
```
