...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/media-elements/video_muted_overriding_volume-manual.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/media-elements/video_muted_overriding_volume-manual.html"
}
```
