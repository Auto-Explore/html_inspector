...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/the-iframe-element/sandbox_017.htm",
...
```json
{
  "messages": [
    ...
    },
    {
      ...
      "message": "Bad value “\fALLOW-SCRIPTS\fallow-same-origin\f” for attribute “sandbox” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1333,
        "byte_start": 1214,
  ...
  "source_name": "html/semantics/embedded-content/the-iframe-element/sandbox_017.htm"
}
```
