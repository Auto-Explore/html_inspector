...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/the-iframe-element/sandbox_021-manual.htm",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/the-iframe-element/sandbox_021-manual.htm"
}
```
