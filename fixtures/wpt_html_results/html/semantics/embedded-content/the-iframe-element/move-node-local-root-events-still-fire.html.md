# html/semantics/embedded-content/the-iframe-element/move-node-local-root-events-still-fire.html
...
{
  "format_version": 1,
  "file": "html/semantics/embedded-content/the-iframe-element/move-node-local-root-events-still-fire.html",
...
```json
{
  ...
  "source_name": "html/semantics/embedded-content/the-iframe-element/move-node-local-root-events-still-fire.html"
}
```
