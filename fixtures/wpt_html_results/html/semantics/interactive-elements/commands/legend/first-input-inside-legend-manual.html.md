...
{
  "format_version": 1,
  "file": "html/semantics/interactive-elements/commands/legend/first-input-inside-legend-manual.html",
...
```json
{
  ...
  "source_name": "html/semantics/interactive-elements/commands/legend/first-input-inside-legend-manual.html"
}
```
