...
{
  "format_version": 1,
  "file": "html/semantics/interactive-elements/the-dialog-element/dialog-open.html",
...
```json
{
  ...
  "source_name": "html/semantics/interactive-elements/the-dialog-element/dialog-open.html"
}
```
