# html/semantics/interactive-elements/the-dialog-element/dialog-form-submission.html
...
{
  "format_version": 1,
  "file": "html/semantics/interactive-elements/the-dialog-element/dialog-form-submission.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Internal encoding declaration “urf-8” disagrees with the actual encoding of the document (“utf-8”).",
      "severity": "Warning",
      "span": {
        "byte_end": 36,
        "byte_start": 16,
  ...
  "source_name": "html/semantics/interactive-elements/the-dialog-element/dialog-form-submission.html"
}
```
