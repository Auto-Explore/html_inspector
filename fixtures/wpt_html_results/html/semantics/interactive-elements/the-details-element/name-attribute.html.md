# html/semantics/interactive-elements/the-details-element/name-attribute.html
...
{
  "format_version": 1,
  "file": "html/semantics/interactive-elements/the-details-element/name-attribute.html",
...
promise_test(async t => {
  ...
  // Test appending a closed element in the gr
```
...
```json
{
  ...
  "source_name": "html/semantics/interactive-elements/the-details-element/name-attribute.html"
}
```
