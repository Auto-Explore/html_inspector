...
{
  "format_version": 1,
  "file": "html/semantics/scripting-1/the-script-element/muted-errors.sub.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “/fetch/api/resources/redirect.py?location=\n//{{domains[www2]}}:{{ports[http][0]}}/fetch/api/resources/redirect.py?location=\n//{{host}}:{{ports[http][0]}}/html/semantics/scripting-1/the-script-element/cacheable-script-throw.py?same-cross-same” for attribute “src” on element “script”.",
      "severity": "Warning",
      "span": {
        "byte_end": 3751,
        "byte_start": 3442,
    ...
    },
    {
      "category": "Html",
      "code": "html.script.src.invalid",
      "message": "Bad value “//{{domains[www2]}}:{{ports[http][0]}}/fetch/api/resources/redirect.py?location=\n//{{host}}:{{ports[http][0]}}/html/semantics/scripting-1/the-script-element/cacheable-script-throw.py?cross-same” for attribute “src” on element “script”.",
      "severity": "Warning",
      "span": {
        "byte_end": 4022,
        "byte_start": 3761,
    ...
    },
    {
      "category": "Html",
      "code": "html.script.src.invalid",
      "message": "Bad value “//{{domains[www2]}}:{{ports[http][0]}}/fetch/api/resources/redirect.py?location=\n//{{host}}:{{ports[http][0]}}/html/semantics/scripting-1/the-script-element/resources/throw.js” for attribute “src” on element “script”.",
      "severity": "Warning",
      "span": {
        "byte_end": 4275,
        "byte_start": 4032,
    ...
    },
    {
      "category": "Html",
      "code": "html.script.src.invalid",
      "message": "Bad value “//{{domains[www2]}}:{{ports[http][0]}}/fetch/api/resources/redirect.py?location=\n//{{host}}:{{ports[http][0]}}/html/semantics/scripting-1/the-script-element/resources/syntax-error.js” for attribute “src” on element “script”.",
      "severity": "Warning",
      "span": {
        "byte_end": 4535,
        "byte_start": 4285,
  ...
  "source_name": "html/semantics/scripting-1/the-script-element/muted-errors.sub.html"
}
```
