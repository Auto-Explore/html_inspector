# html/semantics/interestfor/interestfor-delay-start.tentative.html
...
{
  "format_version": 1,
  "file": "html/semantics/interestfor/interestfor-delay-start.tentative.html",
...
},`interestfor interest-delay-start is respected, ${description}`);
...
```json
{
  ...
  "source_name": "html/semantics/interestfor/interestfor-delay-start.tentative.html"
}
```
