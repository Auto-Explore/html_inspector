# html/semantics/interestfor/interestfor-delay-end.tentative.html
...
{
  "format_version": 1,
  "file": "html/semantics/interestfor/interestfor-delay-end.tentative.html",
...
},`The interest-delay-end causes interest to be lost after a delay, ${description}`);
...
```json
{
  ...
  "source_name": "html/semantics/interestfor/interestfor-delay-end.tentative.html"
}
```
