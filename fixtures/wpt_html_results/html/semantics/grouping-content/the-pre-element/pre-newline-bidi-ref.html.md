...
{
  "format_version": 1,
  "file": "html/semantics/grouping-content/the-pre-element/pre-newline-bidi-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/grouping-content/the-pre-element/pre-newline-bidi-ref.html"
}
```
