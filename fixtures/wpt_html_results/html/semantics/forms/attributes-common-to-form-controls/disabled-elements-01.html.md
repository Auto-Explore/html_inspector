...
{
  "format_version": 1,
  "file": "html/semantics/forms/attributes-common-to-form-controls/disabled-elements-01.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/attributes-common-to-form-controls/disabled-elements-01.html"
}
```
