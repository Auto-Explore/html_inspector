...
{
  "format_version": 1,
  "file": "html/semantics/forms/attributes-common-to-form-controls/dirname-only-if-applies.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/attributes-common-to-form-controls/dirname-only-if-applies.html"
}
```
