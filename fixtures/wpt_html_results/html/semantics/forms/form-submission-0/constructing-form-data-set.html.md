...
{
  "format_version": 1,
  "file": "html/semantics/forms/form-submission-0/constructing-form-data-set.html",
...
```json
{
  "messages": [
    ...
    {
      "category": "Html",
      "code": "html.form.accept_charset.only_utf8",
      "message": "The only allowed value for the “accept-charset” attribute for the “form” element is “utf-8”.",
      "severity": "Warning",
      "span": {
        "byte_end": 609,
        "byte_start": 520,
  ...
  "source_name": "html/semantics/forms/form-submission-0/constructing-form-data-set.html"
}
```
