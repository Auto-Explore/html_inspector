...
{
  "format_version": 1,
  "file": "html/semantics/forms/form-submission-0/form-submission-algorithm.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/form-submission-0/form-submission-algorithm.html"
}
```
