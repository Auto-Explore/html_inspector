...
{
  "format_version": 1,
  "file": "html/semantics/forms/form-submission-0/form-double-submit-preventdefault.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/form-submission-0/form-double-submit-preventdefault.html"
}
```
