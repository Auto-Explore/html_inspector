# html/semantics/forms/the-textarea-element/change-to-empty-value.html
...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-textarea-element/change-to-empty-value.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-textarea-element/change-to-empty-value.html"
}
```
