...
{
  "format_version": 1,
  "file": "html/semantics/forms/constraints/tooShort-input-email-add-manual.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/constraints/tooShort-input-email-add-manual.html"
}
```
