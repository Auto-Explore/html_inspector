...
{
  "format_version": 1,
  "file": "html/semantics/forms/constraints/tooShort-input-text-add-manual.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/constraints/tooShort-input-text-add-manual.html"
}
```
