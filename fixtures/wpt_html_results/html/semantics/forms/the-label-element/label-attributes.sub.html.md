...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-label-element/label-attributes.sub.html",
...
<script>
  ...
  test(function () {
    ...
    assert_equals(document.getElementById("lbl2").control, null,
                  "The labeled cotrol should be ass
```
...
```json
{
  "messages": [
    ...
    {
      "category": "Html",
      "code": "html.label.for.descendant_input_id_mismatch",
    ...
    },
    {
      ...
      "message": "Bad value “” for attribute “id” on element “input”.",
      "severity": "Warning",
      "span": {
        "byte_end": 744,
        "byte_start": 716,
  ...
  "source_name": "html/semantics/forms/the-label-element/label-attributes.sub.html"
}
```
