...
{
  "format_version": 1,
  "file": "html/semantics/forms/form-control-infrastructure/form_attribute.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/form-control-infrastructure/form_attribute.html"
}
```
