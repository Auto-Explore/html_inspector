# html/semantics/forms/the-input-element/radio-focused-and-scrolled-into-view.html
...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-input-element/radio-focused-and-scrolled-into-view.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-input-element/radio-focused-and-scrolled-into-view.html"
}
```
