...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-input-element/date.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “1999-1” for attribute “min” on element “input”.",
      "severity": "Warning",
      "span": {
        "byte_end": 905,
        "byte_start": 819,
    ...
    },
    {
      "category": "Html",
      "code": "html.input.date.invalid",
      "message": "Bad value “2011-13-162-777” for attribute “max” on element “input”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1007,
        "byte_start": 912,
    ...
    },
    {
      "category": "Html",
      "code": "html.input.date.invalid",
      "message": "Bad value “invalid-date” for attribute “value” on element “input”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1213,
        "byte_start": 1119,
  ...
  "source_name": "html/semantics/forms/the-input-element/date.html"
}
```
