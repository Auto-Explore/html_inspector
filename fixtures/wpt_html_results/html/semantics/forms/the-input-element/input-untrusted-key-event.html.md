...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-input-element/input-untrusted-key-event.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-input-element/input-untrusted-key-event.html"
}
```
