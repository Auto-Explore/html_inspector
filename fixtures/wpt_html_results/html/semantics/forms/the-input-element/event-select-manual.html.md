# html/semantics/forms/the-input-element/event-select-manual.html
...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-input-element/event-select-manual.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-input-element/event-select-manual.html"
}
```
