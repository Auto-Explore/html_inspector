...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-input-element/range.html",
...
```json
{
  "messages": [
    ...
    {
      "category": "Html",
      "code": "html.input.range.min.invalid",
      "message": "Bad value “ab” for attribute “min” on element “input”.",
      "severity": "Warning",
      "span": {
        "byte_end": 2459,
        "byte_start": 2395,
    ...
    },
    {
      ...
      "message": "Bad value “xyz” for attribute “step” on element “input”.",
      "severity": "Warning",
      "span": {
        "byte_end": 2551,
        "byte_start": 2466,
  ...
  "source_name": "html/semantics/forms/the-input-element/range.html"
}
```
