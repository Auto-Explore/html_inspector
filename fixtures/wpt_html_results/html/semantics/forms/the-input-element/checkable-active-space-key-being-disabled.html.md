# html/semantics/forms/the-input-element/checkable-active-space-key-being-disabled.html
...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-input-element/checkable-active-space-key-being-disabled.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-input-element/checkable-active-space-key-being-disabled.html"
}
```
