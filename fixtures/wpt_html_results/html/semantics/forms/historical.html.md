...
{
  "format_version": 1,
  "file": "html/semantics/forms/historical.html",
...
```json
{
  "messages": [
    ...
    {
      "category": "Html",
      "code": "html.input.name.isindex.disallowed",
      "message": "The value “isindex” for the “name” attribute of the “input” element is not allowed.",
      "severity": "Warning",
      "span": {
        "byte_end": 695,
        "byte_start": 667,
  ...
  "source_name": "html/semantics/forms/historical.html"
}
```
