...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-select-element/common-HTMLOptionsCollection-namedItem.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-select-element/common-HTMLOptionsCollection-namedItem.html"
}
```
