...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-select-element/select-selectedOptions.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-select-element/select-selectedOptions.html"
}
```
