# html/semantics/forms/the-select-element/customizable-select/nested-options.html
...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-select-element/customizable-select/nested-options.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-select-element/customizable-select/nested-options.html"
}
```
