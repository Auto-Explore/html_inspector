...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-select-element/customizable-select/select-appearance-switching-invalidation-ref.html",
...
<div id=popover popover=auto anchor=button class=customizable-select-popover>
  ...
  <div class=customizable-select-option>
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-select-element/customizable-select/select-appearance-switching-invalidation-ref.html"
}
```
