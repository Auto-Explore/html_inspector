...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-form-element/resources/form-no-action-with-base.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-form-element/resources/form-no-action-with-base.html"
}
```
