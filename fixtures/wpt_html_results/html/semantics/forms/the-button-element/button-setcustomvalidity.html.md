...
{
  "format_version": 1,
  "file": "html/semantics/forms/the-button-element/button-setcustomvalidity.html",
...
```json
{
  ...
  "source_name": "html/semantics/forms/the-button-element/button-setcustomvalidity.html"
}
```
