...
{
  "format_version": 1,
  "file": "html/semantics/selectors/pseudo-classes/readwrite-readonly.html",
...
```json
{
  "messages": [
    ...
    {
      "category": "Html",
      "code": "html.input.readonly.disallowed_for_type",
      "message": "Attribute “readonly” is only allowed when the input type is “date”, “datetime-local”, “email”, “month”, “number”, “password”, “search”, “tel”, “text”, “time”, “url”, or “week”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1141,
        "byte_start": 1101,
  ...
  "source_name": "html/semantics/selectors/pseudo-classes/readwrite-readonly.html"
}
```
