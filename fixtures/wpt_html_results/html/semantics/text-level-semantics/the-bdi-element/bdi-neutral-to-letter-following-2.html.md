...
{
  "format_version": 1,
  "file": "html/semantics/text-level-semantics/the-bdi-element/bdi-neutral-to-letter-following-2.html",
...
```json
{
  ...
  "source_name": "html/semantics/text-level-semantics/the-bdi-element/bdi-neutral-to-letter-following-2.html"
}
```
