...
{
  "format_version": 1,
  "file": "html/semantics/text-level-semantics/the-bdi-element/bdi-neutral-to-letter-following-1-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/text-level-semantics/the-bdi-element/bdi-neutral-to-letter-following-1-ref.html"
}
```
