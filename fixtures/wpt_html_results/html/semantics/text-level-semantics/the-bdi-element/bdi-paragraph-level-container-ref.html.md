...
{
  "format_version": 1,
  "file": "html/semantics/text-level-semantics/the-bdi-element/bdi-paragraph-level-container-ref.html",
...
```json
{
  ...
  "source_name": "html/semantics/text-level-semantics/the-bdi-element/bdi-paragraph-level-container-ref.html"
}
```
