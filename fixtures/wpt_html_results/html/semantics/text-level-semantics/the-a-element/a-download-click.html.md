...
{
  "format_version": 1,
  "file": "html/semantics/text-level-semantics/the-a-element/a-download-click.html",
...
```json
{
  ...
  "source_name": "html/semantics/text-level-semantics/the-a-element/a-download-click.html"
}
```
