# html/cross-origin-embedder-policy/require-corp-revalidated-images.https.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/require-corp-revalidated-images.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/require-corp-revalidated-images.https.html"
}
```
