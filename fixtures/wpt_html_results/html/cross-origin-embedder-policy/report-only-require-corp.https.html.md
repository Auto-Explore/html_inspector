# html/cross-origin-embedder-policy/report-only-require-corp.https.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/report-only-require-corp.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/report-only-require-corp.https.html"
}
```
