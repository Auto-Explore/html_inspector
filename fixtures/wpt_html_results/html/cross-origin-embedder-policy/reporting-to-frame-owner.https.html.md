# html/cross-origin-embedder-policy/reporting-to-frame-owner.https.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/reporting-to-frame-owner.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/reporting-to-frame-owner.https.html"
}
```
