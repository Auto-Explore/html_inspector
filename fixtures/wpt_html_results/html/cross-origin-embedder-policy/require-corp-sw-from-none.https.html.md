...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/require-corp-sw-from-none.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/require-corp-sw-from-none.https.html"
}
```
