...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/none-sw-from-require-corp.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/none-sw-from-require-corp.https.html"
}
```
