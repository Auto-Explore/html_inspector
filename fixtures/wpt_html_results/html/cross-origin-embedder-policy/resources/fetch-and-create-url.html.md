# html/cross-origin-embedder-policy/resources/fetch-and-create-url.html
...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/resources/fetch-and-create-url.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/resources/fetch-and-create-url.html"
}
```
