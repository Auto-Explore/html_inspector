...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/block-local-documents-inheriting-none.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/block-local-documents-inheriting-none.https.html"
}
```
