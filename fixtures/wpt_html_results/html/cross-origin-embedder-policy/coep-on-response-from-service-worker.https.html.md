...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/coep-on-response-from-service-worker.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/coep-on-response-from-service-worker.https.html"
}
```
