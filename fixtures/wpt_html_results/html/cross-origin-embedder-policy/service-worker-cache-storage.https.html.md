...
{
  "format_version": 1,
  "file": "html/cross-origin-embedder-policy/service-worker-cache-storage.https.html",
...
```json
{
  ...
  "source_name": "html/cross-origin-embedder-policy/service-worker-cache-storage.https.html"
}
```
