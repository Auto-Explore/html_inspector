...
{
  "format_version": 1,
  "file": "html/canvas/offscreen/manual/text/canvas.2d.offscreen.transferred.direction.inherit.html",
...
```json
{
  ...
  "source_name": "html/canvas/offscreen/manual/text/canvas.2d.offscreen.transferred.direction.inherit.html"
}
```
