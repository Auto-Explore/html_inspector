# html/canvas/offscreen/manual/layers/unclosed-layers.w.html
...
{
  "format_version": 1,
  "file": "html/canvas/offscreen/manual/layers/unclosed-layers.w.html",
...
```json
{
  ...
  "source_name": "html/canvas/offscreen/manual/layers/unclosed-layers.w.html"
}
```
