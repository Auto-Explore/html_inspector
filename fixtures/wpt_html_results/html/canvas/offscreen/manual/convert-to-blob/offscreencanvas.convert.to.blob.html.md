...
{
  "format_version": 1,
  "file": "html/canvas/offscreen/manual/convert-to-blob/offscreencanvas.convert.to.blob.html",
...
```json
{
  ...
  "source_name": "html/canvas/offscreen/manual/convert-to-blob/offscreencanvas.convert.to.blob.html"
}
```
