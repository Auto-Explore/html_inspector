...
{
  "format_version": 1,
  "file": "html/canvas/offscreen/manual/wide-gamut-canvas/2d.color.space.p3.convertToBlobp3.canvas.html",
...
```json
{
  ...
  "source_name": "html/canvas/offscreen/manual/wide-gamut-canvas/2d.color.space.p3.convertToBlobp3.canvas.html"
}
```
