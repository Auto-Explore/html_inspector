# html/canvas/element/manual/layers/unclosed-layers.html
...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/layers/unclosed-layers.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/layers/unclosed-layers.html"
}
```
