...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/context-attributes/canvas-with-padding.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/context-attributes/canvas-with-padding.html"
}
```
