# html/canvas/element/manual/drawing-images-to-the-canvas/drawimage_canvas.html
...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/drawing-images-to-the-canvas/drawimage_canvas.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/drawing-images-to-the-canvas/drawimage_canvas.html"
}
```
