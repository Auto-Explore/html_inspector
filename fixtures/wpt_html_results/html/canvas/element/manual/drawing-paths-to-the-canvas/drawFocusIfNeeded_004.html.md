...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/drawing-paths-to-the-canvas/drawFocusIfNeeded_004.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/drawing-paths-to-the-canvas/drawFocusIfNeeded_004.html"
}
```
