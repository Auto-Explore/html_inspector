# html/canvas/element/manual/drawing-paths-to-the-canvas/drawFocusIfNeeded_003.html
...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/drawing-paths-to-the-canvas/drawFocusIfNeeded_003.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/drawing-paths-to-the-canvas/drawFocusIfNeeded_003.html"
}
```
