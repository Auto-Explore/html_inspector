# html/canvas/element/manual/the-canvas-state/canvas_state_restore_001.htm
...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/the-canvas-state/canvas_state_restore_001.htm",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/the-canvas-state/canvas_state_restore_001.htm"
}
```
