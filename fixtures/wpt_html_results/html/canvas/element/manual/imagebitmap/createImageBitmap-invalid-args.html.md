...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/imagebitmap/createImageBitmap-invalid-args.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/imagebitmap/createImageBitmap-invalid-args.html"
}
```
