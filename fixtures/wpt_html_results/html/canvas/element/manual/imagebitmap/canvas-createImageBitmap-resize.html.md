...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/imagebitmap/canvas-createImageBitmap-resize.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/imagebitmap/canvas-createImageBitmap-resize.html"
}
```
