...
{
  "format_version": 1,
  "file": "html/canvas/element/manual/imagebitmap/createImageBitmap-exif-orientation_none.html",
...
```json
{
  ...
  "source_name": "html/canvas/element/manual/imagebitmap/createImageBitmap-exif-orientation_none.html"
}
```
