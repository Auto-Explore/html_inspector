# html/editing/dnd/images/007.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/images/007.html",
...
<body>
  <p><img
      ...
      alt="PNG circle" ondragstart="event.dataTransfer.effectAllowed = 'copy'" /></p>
  ...
  <script>
    async function test() {
      ...
      dragDropTest(img, div, onDropCallBack, 'Dragging a dataURL image to an iframe should copy it there', /*dragIframe=*/null, iframe);
    }
    test();
  </script>
</body>
...
```json
{
  ...
  "source_name": "html/editing/dnd/images/007.html"
}
```
