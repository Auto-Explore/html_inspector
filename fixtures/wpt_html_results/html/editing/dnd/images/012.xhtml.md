# html/editing/dnd/images/012.xhtml
...
{
  "format_version": 1,
  "file": "html/editing/dnd/images/012.xhtml",
...
<head>
  <title>Drag and drop of dataURL image between iframes</title>
  <style>
    body {
      display: flex;
...
<body>
  <iframe src="012-1.xhtml" id="drag-iframe"></iframe>
...
```json
{
  ...
  "source_name": "html/editing/dnd/images/012.xhtml"
}
```
