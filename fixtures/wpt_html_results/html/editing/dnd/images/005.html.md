...
{
  "format_version": 1,
  "file": "html/editing/dnd/images/005.html",
...
<script>
  async function test() {
    ...
    dragDropTest(img, div, onDropCallBack,
      'Dragging the dataURL JPG image to the bottom div should copy the image there');
  }
  test();
</script>
</html>
...
```json
{
  ...
  "source_name": "html/editing/dnd/images/005.html"
}
```
