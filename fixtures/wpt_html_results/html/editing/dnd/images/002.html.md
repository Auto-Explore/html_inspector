...
{
  "format_version": 1,
  "file": "html/editing/dnd/images/002.html",
  ...
  <script>
    async function test() {
      ...
      dragDropTest(img, div, onDropCallBack,
        'Dragging the dataURL PNG image to the bottom div should copy the image there');
    }
    test();
  </script>
</body>
...
```json
{
  ...
  "source_name": "html/editing/dnd/images/002.html"
}
```
