# html/editing/dnd/interactiveelements/input_text_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/input_text_inside_draggable_element.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <div draggable="true" id="element">
      <input value="Dummy text" id="inner">
    </div>
    ...
    }, "Input text inside draggable element should not be draggable border");
    ...
    }, "Draggable input text should not be draggable while attempting to select text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/input_text_inside_draggable_element.html"
}
```
