# html/editing/dnd/interactiveelements/input_submit_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/input_submit_inside_draggable_element.html",
...
<html>
  <head>
    <title>Input submit inside draggable element</title>
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <div draggable="true" id="outer">
      <input type="submit" value="Dummy text" id="inner">
    </div>
    ...
    testDragInputSubmitButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Input submit button inside draggable element should be draggable from border");
    ...
    testDragInputSubmitButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Input submit button inside draggable element should be draggable from button text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/input_submit_inside_draggable_element.html"
}
```
