# html/editing/dnd/interactiveelements/disabled_input_text_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/disabled_input_text_inside_draggable_element.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <div draggable="true" id="element">
      <input value="Dummy text" id="inner" disabled>
    </div>
    ...
    }, "Disabled text input with inside draggable element should not be draggable from border");
    ...
    }, "Disabled text input with inside draggable element should not be draggable while attempting to select text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/disabled_input_text_inside_draggable_element.html"
}
```
