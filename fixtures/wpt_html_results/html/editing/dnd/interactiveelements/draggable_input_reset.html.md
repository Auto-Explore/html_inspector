# html/editing/dnd/interactiveelements/draggable_input_reset.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/draggable_input_reset.html",
...
<html>
  <head>
    <title>Draggable input reset</title>
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <p>Press your mouse button down on the orange block and drag downwards. It should drag the input reset.</p>
    <p>Press your mouse button down on the text and drag rightward. It should drag the input reset.</p>
    <div id="outer">
      <input type="reset" value="Dummy text" draggable="true" id="inner">
    </div>
    ...
    function testDragInputResetButton(dragActionFun, msg) {
      promise_test(t => {
    ...
    testDragInputResetButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Draggable input reset button should be draggable from border");
    ...
    testDragInputResetButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Draggable input reset button should be draggable from button text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/draggable_input_reset.html"
}
```
