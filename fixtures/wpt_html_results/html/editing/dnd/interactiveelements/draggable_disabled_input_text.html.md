# html/editing/dnd/interactiveelements/draggable_disabled_input_text.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/draggable_disabled_input_text.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <div id="element">
      <input value="Dummy text" draggable="true" id="inner" disabled>
    </div>
    ...
    }, "Disabled draggable text input should not be draggable from border");
    ...
    }, "Disabled draggable text input should not be draggable while attempting to select text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/draggable_disabled_input_text.html"
}
```
