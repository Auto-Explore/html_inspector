# html/editing/dnd/interactiveelements/draggable_input_submit.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/draggable_input_submit.html",
...
<html>
  <head>
    <title>Draggable input submit</title>
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <p>Press your mouse button down on the orange block and drag downwards. It should drag the input submit.</p>
    <p>Press your mouse button down on the text and drag rightward. It should drag the input submit.</p>
    <div id="outer">
      <input type="submit" value="Dummy text" draggable="true" id="inner">
    </div>
    ...
    function testDragInputSubmitButton(dragActionFun, msg) {
      promise_test(t => {
    ...
    testDragInputSubmitButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Draggable input submit button should be draggable from border");
    ...
    testDragInputSubmitButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Draggable input submit button should be draggable from button text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/draggable_input_submit.html"
}
```
