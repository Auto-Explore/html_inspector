# html/editing/dnd/interactiveelements/contenteditable_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/contenteditable_inside_draggable_element.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <p>Press your mouse button down on the orange block and drag downwards. It should <strong>not</strong> drag the text or the button. Use your mouse to select the dummy text. It should <strong>not</strong> drag the text or the orange block.</p>
    <div draggable="true" id="element">
      <div contenteditable="true" id="inner">Dummy text</div>
    </div>
    ...
    }, "Contenteditable inside draggable element should not be draggable from border");
    ...
    }, "Contenteditable inside draggable element should not be draggable while selecting text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/contenteditable_inside_draggable_element.html"
}
```
