# html/editing/dnd/interactiveelements/draggable_input_text.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/draggable_input_text.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <div id="element">
      <input value="Dummy text" draggable="true" id="inner">
    </div>
    ...
    }, "Draggable input text should not be draggable from border");
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/draggable_input_text.html"
}
```
