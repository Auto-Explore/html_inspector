# html/editing/dnd/interactiveelements/input_button_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/input_button_inside_draggable_element.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <div draggable="true" id="outer">
      <input type="button" value="Dummy text" id="inner">
    </div>
    ...
    testDragInputButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Input button inside draggable element should be draggable from border");
    ...
    testDragInputButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Input button inside draggable element should be draggable from button text");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/input_button_inside_draggable_element.html"
}
```
