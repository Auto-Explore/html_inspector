# html/editing/dnd/interactiveelements/select_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/select_inside_draggable_element.html",
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    }, "Select input inside draggable element should not be draggable from border");
    ...
    }, "Select input inside draggable element should not be draggable from select body");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/select_inside_draggable_element.html"
}
```
