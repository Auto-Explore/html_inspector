# html/editing/dnd/interactiveelements/input_image_inside_draggable_element.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/interactiveelements/input_image_inside_draggable_element.html",
...
<html>
  <head>
    <title>Input image inside draggable element</title>
...
#inner { border: 1px solid orange; border-top-width: 20px; }
  ...
  <body>
    ...
    <p>Press your mouse button down on the image and drag downwards. It should drag the draggable element.</p>
    <div draggable="true" id="outer">
      <input type="image" src="../resources/circle.png" value="Dummy text" id="inner">
    </div>
    ...
    testDragInputImageButton(async () => {
      ...
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Input image button inside draggable element should be draggable from border");
    ...
    testDragInputImageButton(async () => {
      new test_driver.Actions()
        ...
        .pointerUp()
        .send();
    }, "Input image button inside draggable element should be draggable from image");
    </script>
...
```json
{
  ...
  "source_name": "html/editing/dnd/interactiveelements/input_image_inside_draggable_element.html"
}
```
