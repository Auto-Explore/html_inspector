...
{
  "format_version": 1,
  "file": "html/editing/dnd/selection/helper-drag-me-textarea-to-other-textarea.xhtml",
...
```json
{
  ...
  "source_name": "html/editing/dnd/selection/helper-drag-me-textarea-to-other-textarea.xhtml"
}
```
