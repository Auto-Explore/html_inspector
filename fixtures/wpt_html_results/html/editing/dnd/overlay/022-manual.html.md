# html/editing/dnd/overlay/022-manual.html
...
{
  "format_version": 1,
  "file": "html/editing/dnd/overlay/022-manual.html",
...
<div draggable="true" ondragstart="document.querySelector('p').firstChild.nodeValue = 'FAIL'"></div>
...
```json
{
  ...
  "source_name": "html/editing/dnd/overlay/022-manual.html"
}
```
