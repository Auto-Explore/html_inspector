# html/dom/aria-attribute-reflection.html
...
{
  "format_version": 1,
  "file": "html/dom/aria-attribute-reflection.html",
...
```json
{
  "messages": [
    {
      "category": "Aria",
      "code": "aria.aria_braillelabel.prohibited_on_role.generic",
      "message": "The “aria-braillelabel” attribute must not be specified on any “div” element unless the element has a “role” value other than “caption”, “code”, “deletion”, “emphasis”, “generic”, “insertion”, “paragraph”, “presentation”, “strong”, “subscript”, or “superscript”.",
      "severity": "Error",
      "span": {
        "byte_end": 2056,
        "byte_start": 2011,
    ...
    {
      "category": "Aria",
      "code": "aria.aria_checked.not_allowed",
      "message": "Attribute “aria-checked” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 3330,
        "byte_start": 3291,
    ...
    {
      "category": "Aria",
      "code": "aria.aria_label.prohibited_on_role.generic",
      "message": "The “aria-label” attribute must not be specified on any “div” element unless the element has a “role” value other than “caption”, “code”, “deletion”, “emphasis”, “generic”, “insertion”, “paragraph”, “presentation”, “strong”, “subscript”, or “superscript”.",
      "severity": "Error",
      "span": {
        "byte_end": 7735,
        "byte_start": 7704,
    ...
    {
      "category": "Aria",
      "code": "aria.aria-multiselectable.not_allowed",
      "message": "Attribute “aria-multiselectable” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 9604,
        "byte_start": 9550,
    ...
    {
      "category": "Aria",
      "code": "aria.aria-placeholder.not_allowed",
      "message": "Attribute “aria-placeholder” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 10489,
        "byte_start": 10446,
    ...
    {
      "category": "Aria",
      "code": "aria.aria_readonly.requires_role_or_state",
      "message": "Element “div” is missing one or more of the following attributes: “aria-checked”, “aria-expanded”, “aria-valuenow”, “role”.",
      "severity": "Error",
      "span": {
        "byte_end": 11668,
        "byte_start": 11628,
    ...
    {
      "category": "Aria",
      "code": "aria.aria-readonly.not_allowed",
      "message": "Attribute “aria-readonly” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 11668,
        "byte_start": 11628,
    ...
    {
      "category": "Aria",
      "code": "aria.aria-selected.not_allowed",
      "message": "Attribute “aria-selected” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 14501,
        "byte_start": 14461,
    ...
    {
      "category": "Aria",
      "code": "aria.aria-valuemax.not_allowed",
      "message": "Attribute “aria-valuemax” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 15646,
        "byte_start": 15608,
    ...
    {
      "category": "Aria",
      "code": "aria.aria-valuemin.not_allowed",
      "message": "Attribute “aria-valuemin” not allowed on element “div” at this point.",
      "severity": "Error",
      "span": {
        "byte_end": 16031,
        "byte_start": 15994,
  ...
  "source_name": "html/dom/aria-attribute-reflection.html"
}
```
