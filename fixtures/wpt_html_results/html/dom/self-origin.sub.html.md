...
{
  "format_version": 1,
  "file": "html/dom/self-origin.sub.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “http://{{domains[www1]}}:{{ports[http][1]}}{{location[path]}}/../resources/self-origin-subframe.html” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 534,
        "byte_start": 419,
    ...
    },
    {
      "category": "Html",
      "code": "html.iframe.src.invalid",
      "message": "Bad value “http://élève.{{domains[]}}:{{ports[http][1]}}{{location[path]}}/../resources/self-origin-subframe.html” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 773,
        "byte_start": 654,
  ...
  "source_name": "html/dom/self-origin.sub.html"
}
```
