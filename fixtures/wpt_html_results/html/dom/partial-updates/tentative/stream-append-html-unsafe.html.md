# html/dom/partial-updates/tentative/stream-append-html-unsafe.html
...
{
  "format_version": 1,
  "file": "html/dom/partial-updates/tentative/stream-append-html-unsafe.html",
...
promise_test(async t => {
    ...
    const writer = element.streamAppendHTMLUnsafe({runScripts: true}).getWriter();
...
```json
{
  ...
  "source_name": "html/dom/partial-updates/tentative/stream-append-html-unsafe.html"
}
```
