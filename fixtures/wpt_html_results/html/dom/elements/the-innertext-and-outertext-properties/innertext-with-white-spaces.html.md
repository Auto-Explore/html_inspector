...
{
  "format_version": 1,
  "file": "html/dom/elements/the-innertext-and-outertext-properties/innertext-with-white-spaces.html",
...
addEventListener("DOMContentLoaded", () => {
  ...
  for (const data of [
    ...
    {
      desc: "CR before <div> should be invisible if
```
...
```json
{
  ...
  "source_name": "html/dom/elements/the-innertext-and-outertext-properties/innertext-with-white-spaces.html"
}
```
