...
{
  "format_version": 1,
  "file": "html/dom/elements/global-attributes/dir_auto-textarea-N-between-Rs.html",
...
```json
{
  ...
  "source_name": "html/dom/elements/global-attributes/dir_auto-textarea-N-between-Rs.html"
}
```
