...
{
  "format_version": 1,
  "file": "html/dom/elements/global-attributes/dir_auto-pre-N-between-Rs-ref.html",
...
```json
{
  ...
  "source_name": "html/dom/elements/global-attributes/dir_auto-pre-N-between-Rs-ref.html"
}
```
