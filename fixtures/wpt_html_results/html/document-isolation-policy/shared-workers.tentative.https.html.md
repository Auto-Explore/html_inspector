# html/document-isolation-policy/shared-workers.tentative.https.html
...
{
  "format_version": 1,
  "file": "html/document-isolation-policy/shared-workers.tentative.https.html",
...
```json
{
  ...
  "source_name": "html/document-isolation-policy/shared-workers.tentative.https.html"
}
```
