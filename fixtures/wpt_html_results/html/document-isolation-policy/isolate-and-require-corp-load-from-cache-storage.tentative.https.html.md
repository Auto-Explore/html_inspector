# html/document-isolation-policy/isolate-and-require-corp-load-from-cache-storage.tentative.https.html
...
{
  "format_version": 1,
  "file": "html/document-isolation-policy/isolate-and-require-corp-load-from-cache-storage.tentative.https.html",
...
```json
{
  ...
  "source_name": "html/document-isolation-policy/isolate-and-require-corp-load-from-cache-storage.tentative.https.html"
}
```
