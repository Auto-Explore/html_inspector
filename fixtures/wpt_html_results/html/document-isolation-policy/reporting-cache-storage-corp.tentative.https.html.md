# html/document-isolation-policy/reporting-cache-storage-corp.tentative.https.html
...
{
  "format_version": 1,
  "file": "html/document-isolation-policy/reporting-cache-storage-corp.tentative.https.html",
...
```json
{
  ...
  "source_name": "html/document-isolation-policy/reporting-cache-storage-corp.tentative.https.html"
}
```
