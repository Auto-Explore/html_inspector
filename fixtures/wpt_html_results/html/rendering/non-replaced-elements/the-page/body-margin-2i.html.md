...
{
  "format_version": 1,
  "file": "html/rendering/non-replaced-elements/the-page/body-margin-2i.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “data:text/html,<!doctype html><body marginheight='100' topmargin='40' bottommargin='50'>100px top/bottom margins, default left/right margins</body>” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 403,
        "byte_start": 223,
  ...
  "source_name": "html/rendering/non-replaced-elements/the-page/body-margin-2i.html"
}
```
