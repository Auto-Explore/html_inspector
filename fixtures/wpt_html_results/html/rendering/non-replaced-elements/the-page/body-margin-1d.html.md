...
{
  "format_version": 1,
  "file": "html/rendering/non-replaced-elements/the-page/body-margin-1d.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “data:text/html,<body leftmargin='100' rightmargin='100'>100px left/right margins, default top/bottom margins</body>” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 317,
        "byte_start": 187,
  ...
  "source_name": "html/rendering/non-replaced-elements/the-page/body-margin-1d.html"
}
```
