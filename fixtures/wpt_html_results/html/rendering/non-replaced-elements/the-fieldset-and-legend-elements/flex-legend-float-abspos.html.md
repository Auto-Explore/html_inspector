# html/rendering/non-replaced-elements/the-fieldset-and-legend-elements/flex-legend-float-abspos.html
...
{
  "format_version": 1,
  "file": "html/rendering/non-replaced-elements/the-fieldset-and-legend-elements/flex-legend-float-abspos.html",
...
```json
{
  ...
  "source_name": "html/rendering/non-replaced-elements/the-fieldset-and-legend-elements/flex-legend-float-abspos.html"
}
```
