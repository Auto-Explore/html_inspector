# html/rendering/widgets/input-date-baseline-print.html
...
{
  "format_version": 1,
  "file": "html/rendering/widgets/input-date-baseline-print.html",
...
```json
{
  ...
  "source_name": "html/rendering/widgets/input-date-baseline-print.html"
}
```
