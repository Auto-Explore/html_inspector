# html/rendering/widgets/button-layout/inline-level.html
...
{
  "format_version": 1,
  "file": "html/rendering/widgets/button-layout/inline-level.html",
...
```json
{
  ...
  "source_name": "html/rendering/widgets/button-layout/inline-level.html"
}
```
