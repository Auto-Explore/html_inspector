...
{
  "format_version": 1,
  "file": "html/rendering/widgets/the-select-element/option-empty-label-to-empty-string.html",
...
```json
{
  ...
  "source_name": "html/rendering/widgets/the-select-element/option-empty-label-to-empty-string.html"
}
```
