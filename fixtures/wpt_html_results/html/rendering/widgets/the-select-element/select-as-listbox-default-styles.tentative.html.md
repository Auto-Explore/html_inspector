...
{
  "format_version": 1,
  "file": "html/rendering/widgets/the-select-element/select-as-listbox-default-styles.tentative.html",
...
```json
{
  ...
  "source_name": "html/rendering/widgets/the-select-element/select-as-listbox-default-styles.tentative.html"
}
```
