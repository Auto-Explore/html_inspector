...
{
  "format_version": 1,
  "file": "html/rendering/replaced-elements/svg-embedded-sizing/svg-in-iframe-percentage.html",
...
```json
{
  ...
  "source_name": "html/rendering/replaced-elements/svg-embedded-sizing/svg-in-iframe-percentage.html"
}
```
