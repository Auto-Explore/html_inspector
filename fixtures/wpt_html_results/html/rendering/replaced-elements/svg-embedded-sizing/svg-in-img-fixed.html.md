# html/rendering/replaced-elements/svg-embedded-sizing/svg-in-img-fixed.html
...
{
  "format_version": 1,
  "file": "html/rendering/replaced-elements/svg-embedded-sizing/svg-in-img-fixed.html",
...
```json
{
  ...
  "source_name": "html/rendering/replaced-elements/svg-embedded-sizing/svg-in-img-fixed.html"
}
```
