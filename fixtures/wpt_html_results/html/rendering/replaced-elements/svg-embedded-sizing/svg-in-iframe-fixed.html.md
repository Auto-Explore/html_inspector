...
{
  "format_version": 1,
  "file": "html/rendering/replaced-elements/svg-embedded-sizing/svg-in-iframe-fixed.html",
...
```json
{
  ...
  "source_name": "html/rendering/replaced-elements/svg-embedded-sizing/svg-in-iframe-fixed.html"
}
```
