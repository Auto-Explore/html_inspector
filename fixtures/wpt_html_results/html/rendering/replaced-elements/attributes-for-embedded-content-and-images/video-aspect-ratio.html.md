...
{
  "format_version": 1,
  "file": "html/rendering/replaced-elements/attributes-for-embedded-content-and-images/video-aspect-ratio.html",
...
promise_test(async function() {
  ...
  video.src = getVideoURI('/media/2x2-green');
  document.body.appendChild(video);
  // The size is 150x150 as there is no default aspect-ratio.
  assert_ratio(video, 1, "aspect ratio before load");
  await new Promise(r => video.addEventListener("loadeddata", r, { once: true }));
...
```json
{
  ...
  "source_name": "html/rendering/replaced-elements/attributes-for-embedded-content-and-images/video-aspect-ratio.html"
}
```
