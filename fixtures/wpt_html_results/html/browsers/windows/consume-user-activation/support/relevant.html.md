# html/browsers/windows/consume-user-activation/support/relevant.html
...
{
  "format_version": 1,
  "file": "html/browsers/windows/consume-user-activation/support/relevant.html",
...
```json
{
  ...
  "source_name": "html/browsers/windows/consume-user-activation/support/relevant.html"
}
```
