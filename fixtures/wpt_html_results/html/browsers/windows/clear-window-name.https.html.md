# html/browsers/windows/clear-window-name.https.html
...
{
  "format_version": 1,
  "file": "html/browsers/windows/clear-window-name.https.html",
...
```json
{
  ...
  "source_name": "html/browsers/windows/clear-window-name.https.html"
}
```
