...
{
  "format_version": 1,
  "file": "html/browsers/windows/nested-browsing-contexts/frameElement.sub.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “http://{{hosts[alt][]}}:{{ports[http][0]}}/html/browsers/windows/nested-browsing-contexts/resources/frameElement-nested-frame.html” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 842,
        "byte_start": 681,
    ...
    },
    {
      "category": "Html",
      "code": "html.iframe.src.invalid",
      "message": "Bad value “http://{{hosts[alt][]}}:{{ports[http][0]}}/html/browsers/windows/nested-browsing-contexts/resources/frameElement-window-post.html” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1046,
        "byte_start": 888,
  ...
  "source_name": "html/browsers/windows/nested-browsing-contexts/frameElement.sub.html"
}
```
