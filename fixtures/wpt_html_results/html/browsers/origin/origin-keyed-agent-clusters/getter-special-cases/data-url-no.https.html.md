...
{
  "format_version": 1,
  "file": "html/browsers/origin/origin-keyed-agent-clusters/getter-special-cases/data-url-no.https.html",
...
```json
{
  ...
  "source_name": "html/browsers/origin/origin-keyed-agent-clusters/getter-special-cases/data-url-no.https.html"
}
```
