...
{
  "format_version": 1,
  "file": "html/browsers/origin/cross-origin-objects/cross-origin-objects-function-caching.html",
...
```json
{
  ...
  "source_name": "html/browsers/origin/cross-origin-objects/cross-origin-objects-function-caching.html"
}
```
