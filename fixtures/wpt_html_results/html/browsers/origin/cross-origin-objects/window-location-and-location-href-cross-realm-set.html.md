...
{
  "format_version": 1,
  "file": "html/browsers/origin/cross-origin-objects/window-location-and-location-href-cross-realm-set.html",
...
```json
{
  ...
  "source_name": "html/browsers/origin/cross-origin-objects/window-location-and-location-href-cross-realm-set.html"
}
```
