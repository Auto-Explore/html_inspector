...
{
  "format_version": 1,
  "file": "html/browsers/origin/relaxing-the-same-origin-restriction/document_domain_setter.html",
...
```json
{
  ...
  "source_name": "html/browsers/origin/relaxing-the-same-origin-restriction/document_domain_setter.html"
}
```
