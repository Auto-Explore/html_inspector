# html/browsers/the-window-object/open-close/open-features-negative-top-left.html
...
{
  "format_version": 1,
  "file": "html/browsers/the-window-object/open-close/open-features-negative-top-left.html",
...
```json
{
  ...
  "source_name": "html/browsers/the-window-object/open-close/open-features-negative-top-left.html"
}
```
