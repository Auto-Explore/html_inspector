# html/browsers/the-window-object/open-close/open-features-non-integer-innerheight.html
...
{
  "format_version": 1,
  "file": "html/browsers/the-window-object/open-close/open-features-non-integer-innerheight.html",
...
```json
{
  ...
  "source_name": "html/browsers/the-window-object/open-close/open-features-non-integer-innerheight.html"
}
```
