# html/browsers/the-window-object/open-close/open-features-non-integer-left.html
...
{
  "format_version": 1,
  "file": "html/browsers/the-window-object/open-close/open-features-non-integer-left.html",
...
```json
{
  ...
  "source_name": "html/browsers/the-window-object/open-close/open-features-non-integer-left.html"
}
```
