# html/browsers/the-window-object/open-close/open-features-non-integer-width.html
...
{
  "format_version": 1,
  "file": "html/browsers/the-window-object/open-close/open-features-non-integer-width.html",
...
```json
{
  ...
  "source_name": "html/browsers/the-window-object/open-close/open-features-non-integer-width.html"
}
```
