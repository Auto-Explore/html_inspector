...
{
  "format_version": 1,
  "file": "html/browsers/history/joint-session-history/joint-session-history-child2.html",
...
```json
{
  ...
  "source_name": "html/browsers/history/joint-session-history/joint-session-history-child2.html"
}
```
