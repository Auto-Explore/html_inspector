...
{
  "format_version": 1,
  "file": "html/browsers/history/the-location-interface/location-protocol-setter-with-colon.sub.html",
...
```json
{
  ...
  "source_name": "html/browsers/history/the-location-interface/location-protocol-setter-with-colon.sub.html"
}
```
