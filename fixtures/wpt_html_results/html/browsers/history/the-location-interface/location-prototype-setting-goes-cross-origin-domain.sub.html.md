...
{
  "format_version": 1,
  "file": "html/browsers/history/the-location-interface/location-prototype-setting-goes-cross-origin-domain.sub.html",
...
```json
{
  ...
  "source_name": "html/browsers/history/the-location-interface/location-prototype-setting-goes-cross-origin-domain.sub.html"
}
```
