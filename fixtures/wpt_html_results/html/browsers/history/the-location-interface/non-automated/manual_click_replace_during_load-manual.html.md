...
{
  "format_version": 1,
  "file": "html/browsers/history/the-location-interface/non-automated/manual_click_replace_during_load-manual.html",
...
```json
{
  ...
  "source_name": "html/browsers/history/the-location-interface/non-automated/manual_click_replace_during_load-manual.html"
}
```
