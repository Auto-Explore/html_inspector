...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/scroll-to-fragid/scroll-frag-percent-encoded.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “has two spaces” for attribute “id” on element “div”.",
      "severity": "Warning",
      "span": {
        "byte_end": 311,
        "byte_start": 248,
    ...
    },
    {
      "category": "Html",
      "code": "html.id.invalid",
      "message": "Bad value “escape collision” for attribute “id” on element “div”.",
      "severity": "Warning",
      "span": {
        "byte_end": 534,
        "byte_start": 469,
  ...
  "source_name": "html/browsers/browsing-the-web/scroll-to-fragid/scroll-frag-percent-encoded.html"
}
```
