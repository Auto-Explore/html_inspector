...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/scroll-to-fragid/scroll-to-id-top.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/scroll-to-fragid/scroll-to-id-top.html"
}
```
