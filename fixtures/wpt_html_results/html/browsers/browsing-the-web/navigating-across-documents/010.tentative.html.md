# html/browsers/browsing-the-web/navigating-across-documents/010.tentative.html
...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/navigating-across-documents/010.tentative.html",
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “javascript:(function() {parent.flag = true; var x = new XMLHttpRequest(); x.open('GET', 'resources/blank.html?pipe=trickle(d2)', false); x.send(); document.write('WRITE <script>parent.postMessage(\"write\", \"*\")</script>'); return 'RETURN <script>parent.postMessage(\"click\", \"*\")</script>'})()” for attribute “action” on element “form”.",
      "severity": "Warning",
      "span": {
        "byte_end": 693,
        "byte_start": 332,
  ...
  "source_name": "html/browsers/browsing-the-web/navigating-across-documents/010.tentative.html"
}
```
