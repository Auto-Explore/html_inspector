# html/browsers/browsing-the-web/navigating-across-documents/refresh/same-document-refresh.html
...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/navigating-across-documents/refresh/same-document-refresh.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/navigating-across-documents/refresh/same-document-refresh.html"
}
```
