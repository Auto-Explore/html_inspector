...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/navigating-across-documents/replace-before-load/form-submit-button-click-during-load.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/navigating-across-documents/replace-before-load/form-submit-button-click-during-load.html"
}
```
