...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/overlapping-navigations-and-traversals/nav-cancelation-2.sub.html",
...
promise_test(async t => {
  ...
  // loading. If this is the case, the postMessage() (that sets
...
```json
{
  "messages": [
    {
      ...
      "message": "Bad value “http://{{domains[www1]}}:{{ports[http][0]}}/html/browsers/browsing-the-web/overlapping-navigations-and-traversals/resources/nav-cancelation-2-helper.html” for attribute “src” on element “iframe”.",
      "severity": "Warning",
      "span": {
        "byte_end": 1576,
        "byte_start": 1408,
  ...
  "source_name": "html/browsers/browsing-the-web/overlapping-navigations-and-traversals/nav-cancelation-2.sub.html"
}
```
