...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/back-forward-cache/service-worker-clients-claim.https.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/back-forward-cache/service-worker-clients-claim.https.html"
}
```
