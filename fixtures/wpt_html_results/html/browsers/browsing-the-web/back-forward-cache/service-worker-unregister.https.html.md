...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/back-forward-cache/service-worker-unregister.https.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/back-forward-cache/service-worker-unregister.https.html"
}
```
