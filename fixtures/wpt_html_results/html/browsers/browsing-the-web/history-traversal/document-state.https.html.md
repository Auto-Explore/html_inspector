# html/browsers/browsing-the-web/history-traversal/document-state.https.html
...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/history-traversal/document-state.https.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/history-traversal/document-state.https.html"
}
```
