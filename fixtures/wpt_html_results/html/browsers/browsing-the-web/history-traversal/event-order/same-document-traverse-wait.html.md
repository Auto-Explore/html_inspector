# html/browsers/browsing-the-web/history-traversal/event-order/same-document-traverse-wait.html
...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/history-traversal/event-order/same-document-traverse-wait.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/history-traversal/event-order/same-document-traverse-wait.html"
}
```
