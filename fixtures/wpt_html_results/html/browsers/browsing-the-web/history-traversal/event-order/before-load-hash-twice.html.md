...
{
  "format_version": 1,
  "file": "html/browsers/browsing-the-web/history-traversal/event-order/before-load-hash-twice.html",
...
```json
{
  ...
  "source_name": "html/browsers/browsing-the-web/history-traversal/event-order/before-load-hash-twice.html"
}
```
