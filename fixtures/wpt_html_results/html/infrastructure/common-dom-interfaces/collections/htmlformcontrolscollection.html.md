...
{
  "format_version": 1,
  "file": "html/infrastructure/common-dom-interfaces/collections/htmlformcontrolscollection.html",
...
```json
{
  ...
  "source_name": "html/infrastructure/common-dom-interfaces/collections/htmlformcontrolscollection.html"
}
```
