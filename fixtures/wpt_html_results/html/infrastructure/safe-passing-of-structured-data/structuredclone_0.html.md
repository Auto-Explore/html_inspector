...
{
  "format_version": 1,
  "file": "html/infrastructure/safe-passing-of-structured-data/structuredclone_0.html",
        ...
        testCollection = [
            ...
            function() {
                ...
                worker.onmessage = t.step_func(function(e) {
                    ...
                    assert_array_equals(obj.data, e.data.da
```
...
```json
{
  ...
  "source_name": "html/infrastructure/safe-passing-of-structured-data/structuredclone_0.html"
}
```
